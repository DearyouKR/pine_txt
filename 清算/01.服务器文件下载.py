...
if __name__ == "__main__":
    server_address = "23.94.73.58"  # 替换为你的服务器地址
    username = "root"  # 替换为你的服务器用户名
    password = "76WuixREA40n8JI2cj"  # 替换为你的服务器密码
    remote_folder = "/root/liquidation/main/data/liquidation/"  # 替换为远程文件夹路径
    ma_folder = "/root/liquidation/main/data/ma_values.json"  # 替换为远程文件夹路径

    is_logged_in = check_login_status(server_address, username, password)
    if is_logged_in:
        download_folder(server_address, username, password, ma_folder, "data")
